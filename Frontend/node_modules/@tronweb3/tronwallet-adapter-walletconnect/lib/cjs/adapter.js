...
class WalletConnectAdapter extends tronwallet_abstract_adapter_1.Adapter {
    ...
    _getChainId(network) {
        const mapped = walletconnect_tron_1.WalletConnectChainID[network];
        if (mapped)
            return mapped;
    ...
    connect(options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                try {
                    if (!this._wallet) {
                        this._wallet = new walletconnect_tron_1.WalletConnectWallet(Object.assign(Object.assign({}, this._config), { network: this._getChainId(this._config.network) }));
                    }
                    ({ address } = yield this._wallet.connect(onUri ? { onUri } : undefined));
                }
                catch (error) {

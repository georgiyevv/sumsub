...
export class WalletConnectAdapter extends Adapter {
    ...
    _getChainId(network) {
        const mapped = WalletConnectChainID[network];
        if (mapped)
            return mapped;
    ...
    connect(options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                try {
                    if (!this._wallet) {
                        this._wallet = new WalletConnectWallet(Object.assign(Object.assign({}, this._config), { network: this._getChainId(this._config.network) }));
                    }

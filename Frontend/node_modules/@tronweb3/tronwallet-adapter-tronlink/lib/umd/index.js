	...
	function requireAdapter () {
		...
		(function (exports$1) {
			...
			class TronLinkAdapter extends tronwallet_abstract_adapter_1.Adapter {
			    ...
			    _checkAndSign(action, ErrorConstructor) {
			        return __awaiter(this, void 0, void 0, function* () {
			            try {
			                const wallet = yield this.checkAndGetWallet();
			                try {
			                    return yield action(wallet);
			                }
			                catch (error) {
			    ...
			    signTransaction(transaction) {
			        return __awaiter(this, void 0, void 0, function* () {
			            return this._checkAndSign((wallet) => wallet.tronWeb.trx.sign(transaction), tronwallet_abstract_adapter_1.WalletSignTransactionError);
			        });
			    }
			    /**
			     *
			    ...
			    multiSign(transaction_1) {
			        return __awaiter(this, arguments, void 0, function* (transaction, options = {}) {
			            ...
			            return this._checkAndSign((wallet) => wallet.tronWeb.trx.multiSign(transaction, undefined, options.permissionId), tronwallet_abstract_adapter_1.WalletSignTransactionError);
			        });
			    }
			    signMessage(message) {
			        return __awaiter(this, void 0, void 0, function* () {
			            return this._checkAndSign((wallet) => __awaiter(this, void 0, void 0, function* () { return wallet.tronWeb.trx.signMessageV2(message); }), tronwallet_abstract_adapter_1.WalletSignMessageError);
			        });
			    }
			    _signTypedData(typedData) {
			        return __awaiter(this, void 0, void 0, function* () {
			            return this._checkAndSign((wallet) => __awaiter(this, void 0, void 0, function* () { return wallet.tronWeb.trx._signTypedData(typedData.domain, typedData.types, typedData.message); }), tronwallet_abstract_adapter_1.WalletSignTypedDataError);
			        });
			    }
			    /**
			    ...
			    isLegacyTronLinkProvider(provider) {
			        return !!(provider === null || provider === void 0 ? void 0 : provider.isTronLink);
			    }
			    hasDesktopLegacyTronLinkProvider() {
			            ...
			            this._checkPromise = new Promise((resolve) => {
			                ...
			                const cleanupDesktopDetection = () => {
			                    ...
			                    if (typeof window !== 'undefined' && handler) {
			                        window.removeEventListener(tronwallet_abstract_adapter_1.TIP6963AnnounceProviderEventName, handler);
			                    }
			                };
			                const finishWithLegacyDetection = () => {
			                    ...
			                    this._updateWallet();
			                    const isSupport = this.state !== tronwallet_abstract_adapter_1.AdapterState.NotFound;
			                ...
			                handler = (event) => {
			                    ...
			                    if (isTronLinkProvider) {
			                        ...
			                        this._listenTronEvent();
			                        this._readyState = tronwallet_abstract_adapter_1.WalletReadyState.Found;
			                        const address = (((_a = this._wallet) === null || _a === void 0 ? void 0 : _a.tronWeb) && ((_b = this._wallet.tronWeb.defaultAddress) === null || _b === void 0 ? void 0 : _b.base58)) || null;
			                ...
			                window.addEventListener(tronwallet_abstract_adapter_1.TIP6963AnnounceProviderEventName, handler);
			                window.dispatchEvent(new Event(tronwallet_abstract_adapter_1.TIP6963RequestProviderEventName));
			            });
			            return this._checkPromise;
			        }
			...
			exports$1.TronLinkAdapter = TronLinkAdapter;

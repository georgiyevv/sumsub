 ...
 */
export function chainIdToScope(chainId) {
    switch (chainId) {
 ...
 */
export function scopeToChainId(scope) {
    switch (scope) {
        case Scope.MAINNET:
            return '0x2b6653dc';
        case Scope.NILE:
...
export function isSessionChangedEvent(event) {
 ...
 * @throws Error if the scope is unsupported.
 */
export function scopeToNetworkType(scope) {
    switch (scope) {
        case Scope.MAINNET:

 ...
 */
export declare function chainIdToScope(chainId: string): Scope;
/**
 ...
 */
export declare function scopeToChainId(scope: Scope): string;
/**
 ...
 */
export declare function getAddressFromCaipAccountId(caipAccountId: string): string;
/**
...
export declare function isSessionChangedEvent(event: any): boolean;
/**
 ...
 * @throws Error if the scope is unsupported.
 */
export declare function scopeToNetworkType(scope: Scope): NetworkType;
export declare function isMetaMaskMobileWebView(): boolean;
/**
 * Open MetaMask app with deeplink
 * @returns true if do the open operation
 */
export declare function openMetaMaskApp(): boolean;

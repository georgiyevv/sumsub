(function (global, factory) {
	...
	function requireCjs$2 () {
		...
		(function (exports$1) {
			...
			__exportStar(requireAdapter$2(), exports$1);
			__exportStar(requireErrors(), exports$1);
			__exportStar(requireTypes$1(), exports$1);
			__exportStar(requireUtils$2(), exports$1);
	...
	function requireUtils () {
		...
		(function (exports$1) {
			Object.defineProperty(exports$1, "__esModule", { value: true });
			exports$1.isTrustApp = void 0;
			exports$1.supportTrust = supportTrust;
			exports$1.openTrustWallet = openTrustWallet;
			const tronwallet_abstract_adapter_1 = /*@__PURE__*/ requireCjs$2();
			...
			exports$1.isTrustApp = isTrustApp;
			function openTrustWallet() {
			    if (!(0, exports$1.isTrustApp)() && (0, tronwallet_abstract_adapter_1.isInMobileBrowser)()) {
	...
	function requireAdapter () {
		...
		(function (exports$1) {
			    ...
			    multiSign(transaction_1) {
			        return __awaiter(this, arguments, void 0, function* (transaction, options = {}) {
			            try {
			                const wallet = yield this.checkAndGetWallet();
			                try {
			                    return yield wallet.tronWeb.trx.multiSign(transaction, undefined, options.permissionId);
			                }
			                catch (error) {
			                    if (error instanceof Error || (typeof error === 'object' && error.message)) {
			                        throw new tronwallet_abstract_adapter_1.WalletSignTransactionError(error.message, error);
			...
			exports$1.TrustAdapter = TrustAdapter;
	...
	function requireCjs () {
		...
		(function (exports$1) {
			...
			var __exportStar = (cjs$2 && cjs$2.__exportStar) || function(m, exports$1) {
			    for (var p in m) if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports$1, p)) __createBinding(exports$1, m, p);
			};
			Object.defineProperty(exports$1, "__esModule", { value: true });

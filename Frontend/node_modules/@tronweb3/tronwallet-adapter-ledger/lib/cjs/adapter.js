...
class LedgerAdapter extends tronwallet_abstract_adapter_1.Adapter {
    ...
    _checkAndSign(action, errorClass, preCheck) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (this.state !== tronwallet_abstract_adapter_1.AdapterState.Connected) {
                ...
                try {
                    ...
                    throw new errorClass(e === null || e === void 0 ? void 0 : e.message, e);
                }
            }
            catch (error) {
                this.emit('error', error);
    ...
    signTransaction(transaction_1) {
        return __awaiter(this, arguments, void 0, function* (transaction, options = {}) {
            ...
            return this._checkAndSign(() => __awaiter(this, void 0, void 0, function* () {
                try {
                    return yield this._wallet.signTransaction(transaction);
                }
                catch (e) {
                    if (fallbackToHashSign && /Too many bytes to encode/.test(e === null || e === void 0 ? void 0 : e.message)) {
                        return yield this._wallet.signTransactionHash(transaction);
                    }
                    throw e;
                }
            }), tronwallet_abstract_adapter_1.WalletSignTransactionError, () => {
                if (!(0, utils_1.txCheck)(transaction)) {
                    throw new tronwallet_abstract_adapter_1.WalletSignTransactionError('Invalid transaction');
                }
            });
        });
    }
    ...
    signTransactionHash(transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            return this._checkAndSign(() => this._wallet.signTransactionHash(transaction), tronwallet_abstract_adapter_1.WalletSignTransactionError, () => {
                if (!(0, utils_1.txCheck)(transaction)) {
                    throw new tronwallet_abstract_adapter_1.WalletSignTransactionError('Invalid transaction');
                }
            });
    ...
    signMessage(message, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return this._checkAndSign(() => __awaiter(this, void 0, void 0, function* () {
                const signature = yield this._wallet.signPersonalMessage(message);
                const { convertSuffix = true } = options !== null && options !== void 0 ? options : {};
                return convertSuffix ? signature.replace(/(00|01)$/, (match) => (match === '00' ? '1b' : '1c')) : signature;
            }), tronwallet_abstract_adapter_1.WalletSignMessageError);
        });
    }
}

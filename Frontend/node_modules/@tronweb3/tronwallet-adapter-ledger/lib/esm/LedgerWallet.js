...
export class LedgerWallet {
    ...
    signTransaction(transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            const signedResponse = yield this._withApp((app, path) => app.signTransaction(path, transaction.raw_data_hex, []));
            return this._mergeSignature(transaction, signedResponse);
        });
    }
    signTransactionHash(transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            const signedResponse = yield this._withApp((app, path) => app.signTransactionHash(path, transaction.txID));
            return this._mergeSignature(transaction, signedResponse);
        });
    }
    _withApp(action) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return yield action(this.app, path);
            }
            finally {
                yield this.cleanUp();
            }
    ...
    _mergeSignature(transaction, signedResponse) {
